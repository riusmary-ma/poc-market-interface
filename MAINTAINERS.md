# Maintaining the docker/poc-market-interface Image

This document is for maintainers of this repository.

## Docker Hub Image

The image is stored on Docker Hub in the [`docker/poc-market-interface`](https://hub.docker.com/r/docker/poc-market-interface) repository.
...
docker buildx build --push --platform linux/amd64,linux/arm64 --tag docker/poc-market-interface .
```
...
```bash
docker run --pull always -p 8088:80 docker/poc-market-interface:latest
```
